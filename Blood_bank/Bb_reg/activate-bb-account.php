...
$sql = 'SELECT * FROM Blood_Bank WHERE account_activation_hash = "' . $token_hash . '"';
...
<p>Account activated successfully. You can now <a href="/Blood_bank/bbank_log_in.php">log in</a>.</p>
